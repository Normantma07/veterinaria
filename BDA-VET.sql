...
CREATE TABLE `citas` (
  ...
  CONSTRAINT `idMascotas` FOREIGN KEY (`idMascotas`) REFERENCES `mascotas` (`idMascotas`)
...
CREATE TABLE `facturas` (
  ...
  CONSTRAINT `idCitas` FOREIGN KEY (`idCitas`) REFERENCES `citas` (`idCitas`),
...
CREATE TABLE `usuarios` (
  ...
  `ultimoIngreso` datetime DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `usuarios` VALUES (5,'admin','d033e22ae348aeb5660fc2140aec35850c4da997','admin','admin@mail.com','0000-00-00 00:00:00',1);
...
-- Dump completed on 2021-04-18 21:58:08
